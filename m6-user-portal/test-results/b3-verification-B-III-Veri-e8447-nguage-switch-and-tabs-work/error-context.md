...
- Name: b3-verification.spec.ts >> B-III Verification >> settings dialog: language switch and tabs work
- Location: tests\e2e\b3-verification.spec.ts:62:7
...
Locator: locator('.fixed.inset-0.z-50')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 3000ms
  - waiting for locator('.fixed.inset-0.z-50')
...
- heading "Marine & Offshore Expert System" [level=1]
- paragraph: Ask questions about classification society rules, engineering standards, equipment specifications, and more.
- button "What are DNV requirements for LNG cargo tank structures?"
- button "Compare ABS and DNV rules for bulk carrier hatch covers"
- button "What does IMO require for ballast water treatment?"
- button "What is the minimum plate thickness for a container ship's main deck according to CCS?"
- button "Explain the fatigue assessment procedure for offshore crane pedestals"
- button "Attach file"
